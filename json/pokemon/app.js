...
btnGetPokemons.onclick = async function () {
  ...
  // tener que converitir nuestra funcion en async sincrona
  ...
  //await sirve para el tiempo no importa lo que demore await lo va a esperar
...
function readPokemons(pokemons) {
  container.innerHTML = ""; ///limpiar el div- html
